...
// import getProductos from "../queries/getProductos"
...
export const ProductosList = () => {
  ...
  const [{ productos, hasMore }] = usePaginatedQuery(getProductos, {
    orderBy: { id: "asc" },
    skip: ITEMS_PER_PAGE * page,
    take: ITEMS_PER_PAGE,
    ...(nombreFiltrer ? { where: { titulo: { contains: nombreFiltrer } } } : ""),
  })
  ...
  return (
    ...
    //       <li key={producto.id}>
    //         <Link href={`/productos/${producto.id}`}>{producto.titulo}</Link>
    //       </li>
    //     ))}
    //   </ul>
